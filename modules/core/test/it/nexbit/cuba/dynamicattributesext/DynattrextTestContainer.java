package it.nexbit.cuba.dynamicattributesext;
...
public class DynattrextTestContainer extends TestContainer {

    public DynattrextTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "it/nexbit/cuba/dynamicattributesext/app.properties",
    ...
    public static class Common extends DynattrextTestContainer {

        public static final DynattrextTestContainer.Common INSTANCE = new DynattrextTestContainer.Common();
